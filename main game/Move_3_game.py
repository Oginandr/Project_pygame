...
class Ball:
    ...
    def move(self, motion):
        """ Функция задающая движение шара в зависимости от принимаемого массива motion скоростей по x и y """
...
while not finished:
    ...
    """ Взаимодействие с устройствами ввода, заполнение массива motion в зависимости от нажатой стрелки """
    ...
    """ Периодическое добавление врагов (каждые 5 с) """
